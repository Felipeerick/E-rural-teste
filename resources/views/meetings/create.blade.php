...
@section('content')
    ...
    <div class="container pt-5" style="height: 100vh;">
        <h1 class="text-center">Cadastrar reunião</h1> 
        <hr>
        <form action="{{ route('meetings.store') }}" method='POST' class='rounded shadow p-3 p-lg-5 form-group' enctype="multipart/form-data">
            ...
            <input type="text" minlength="3" maxlength="40" maxlength="20" required name="name" class="form-control"  placeholder="Nome do video">
            ...
            <div class='text-center'>
                <button type="submit" class='btn btn-warning mt-2'>Cadastrar reunião</button>
            </div>
        </form>
   </div>
@endsection